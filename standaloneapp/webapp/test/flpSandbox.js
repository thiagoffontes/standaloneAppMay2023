		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#treinamentostandaloneapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinamentostandaloneapp-display": {
								"semanticObject": "treinamentostandaloneapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinamento.standaloneapp",
									"url": sap.ui.require.toUrl("treinamento/standaloneapp")
								}
							}
						}
					}
